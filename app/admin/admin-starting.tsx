...
export default function AdminStartingPage() {
    ...
    return (
        <main className="relative min-h-screen w-full flex items-center justify-center bg-[#090a0f] overflow-hidden font-sans select-none">
            ...
            <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
                <div className="absolute -top-40 -right-40 w-[600px] h-[600px] rounded-full opacity-[0.10] blur-[150px]" style={{ backgroundColor: '#00A8FC' }} />
                <div className="absolute -bottom-40 -left-40 w-[600px] h-[600px] rounded-full opacity-[0.06] blur-[120px]" style={{ backgroundColor: '#00A8FC' }} />
                ...
                <div className="bg-[#12131a]/65 backdrop-blur-[24px] rounded-2xl border border-white/[0.07] p-8 shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex flex-col items-center">
                    ...
                    <div className="flex flex-col items-center mb-8">
                        <div className="w-14 h-14 rounded-full bg-white/[0.02] border border-white/[0.08] flex items-center justify-center mb-4 relative group">
                            <div className="absolute inset-0 rounded-full bg-[#00A8FC] opacity-0 group-hover:opacity-10 blur-md transition-opacity duration-300" />
                            <ShieldCheck className="w-6 h-6 text-[#00A8FC]" />
                        </div>
                        <h1 className="text-xl font-semibold text-white tracking-wide">Acceso Admin</h1>
                        <p className="text-xs text-gray-400 mt-1.5 text-center px-4">
                            Ingresa tu clave de Administrador para acceder al panel de analíticas y ROI.
                        </p>
                    </div>

                    <form onSubmit={handleSubmit} className="w-full flex flex-col gap-5">
                        <div className="flex flex-col gap-2">
                            <label htmlFor="admin-password" className="text-xs font-medium text-gray-300 tracking-wider uppercase pl-0.5">
                            ...
                            <div className="relative w-full">
                                <input
                                    ...
                                    required
                                    placeholder="••••••••••••"
                                    className="w-full bg-[#0d0e12]/80 border border-white/[0.08] focus:border-[#00A8FC]/70 rounded-lg px-4 py-3 text-sm text-white placeholder-gray-600 focus:outline-none transition-all duration-300 pr-11 shadow-inner shadow-black/40"
                                />
                                <button
                                    type="button"
                                    tabIndex={-1}
                        ...
                        <button
                            type="submit"
                            disabled={loading || success}
                            className="relative overflow-hidden w-full bg-[#00A8FC] hover:bg-[#0086C9] active:scale-[0.98] text-white text-sm font-semibold py-3 rounded-lg transition-all duration-200 disabled:opacity-75 shadow-lg shadow-[#00A8FC]/25 mt-2 flex items-center justify-center gap-2"
                        >
                            {loading ? (
