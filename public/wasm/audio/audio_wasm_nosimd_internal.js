...
function assignWasmExports(wasmExports) {
  _configureAudio = Module["_configureAudio"] = wasmExports["Qb"];
  _addAudioToInputStream = Module["_addAudioToInputStream"] = wasmExports["Sb"];
  _free = Module["_free"] = wasmExports["Tb"];
  _malloc = Module["_malloc"] = wasmExports["Ub"];
  _registerModelResourcesGraphService = Module["_registerModelResourcesGraphService"] = wasmExports["Vb"];
  _bindTextureToStream = Module["_bindTextureToStream"] = wasmExports["Wb"];
  _addBoundTextureToStream = Module["_addBoundTextureToStream"] = wasmExports["Xb"];
  _addDoubleToInputStream = Module["_addDoubleToInputStream"] = wasmExports["Yb"];
  _addFloatToInputStream = Module["_addFloatToInputStream"] = wasmExports["Zb"];
  _addBoolToInputStream = Module["_addBoolToInputStream"] = wasmExports["_b"];
  _addIntToInputStream = Module["_addIntToInputStream"] = wasmExports["$b"];
  _addUintToInputStream = Module["_addUintToInputStream"] = wasmExports["ac"];
  _addStringToInputStream = Module["_addStringToInputStream"] = wasmExports["bc"];
  _addRawDataSpanToInputStream = Module["_addRawDataSpanToInputStream"] = wasmExports["cc"];
  _allocateBoolVector = Module["_allocateBoolVector"] = wasmExports["dc"];
  _allocateFloatVector = Module["_allocateFloatVector"] = wasmExports["ec"];
  _allocateDoubleVector = Module["_allocateDoubleVector"] = wasmExports["fc"];
  _allocateIntVector = Module["_allocateIntVector"] = wasmExports["gc"];
  _allocateUintVector = Module["_allocateUintVector"] = wasmExports["hc"];
  _allocateStringVector = Module["_allocateStringVector"] = wasmExports["ic"];
  _addBoolVectorEntry = Module["_addBoolVectorEntry"] = wasmExports["jc"];
  _addFloatVectorEntry = Module["_addFloatVectorEntry"] = wasmExports["kc"];
  _addDoubleVectorEntry = Module["_addDoubleVectorEntry"] = wasmExports["lc"];
  _addIntVectorEntry = Module["_addIntVectorEntry"] = wasmExports["mc"];
  _addUintVectorEntry = Module["_addUintVectorEntry"] = wasmExports["nc"];
  _addStringVectorEntry = Module["_addStringVectorEntry"] = wasmExports["oc"];
  _addBoolVectorToInputStream = Module["_addBoolVectorToInputStream"] = wasmExports["pc"];
  _addFloatVectorToInputStream = Module["_addFloatVectorToInputStream"] = wasmExports["qc"];
  _addDoubleVectorToInputStream = Module["_addDoubleVectorToInputStream"] = wasmExports["rc"];
  _addIntVectorToInputStream = Module["_addIntVectorToInputStream"] = wasmExports["sc"];
  _addUintVectorToInputStream = Module["_addUintVectorToInputStream"] = wasmExports["tc"];
  _addStringVectorToInputStream = Module["_addStringVectorToInputStream"] = wasmExports["uc"];
  _addFlatHashMapToInputStream = Module["_addFlatHashMapToInputStream"] = wasmExports["vc"];
  _addProtoToInputStream = Module["_addProtoToInputStream"] = wasmExports["wc"];
  _addEmptyPacketToInputStream = Module["_addEmptyPacketToInputStream"] = wasmExports["xc"];
  _addBoolToInputSidePacket = Module["_addBoolToInputSidePacket"] = wasmExports["yc"];
  _addDoubleToInputSidePacket = Module["_addDoubleToInputSidePacket"] = wasmExports["zc"];
  _addFloatToInputSidePacket = Module["_addFloatToInputSidePacket"] = wasmExports["Ac"];
  _addIntToInputSidePacket = Module["_addIntToInputSidePacket"] = wasmExports["Bc"];
  _addUintToInputSidePacket = Module["_addUintToInputSidePacket"] = wasmExports["Cc"];
  _addStringToInputSidePacket = Module["_addStringToInputSidePacket"] = wasmExports["Dc"];
  _addRawDataSpanToInputSidePacket = Module["_addRawDataSpanToInputSidePacket"] = wasmExports["Ec"];
  _addProtoToInputSidePacket = Module["_addProtoToInputSidePacket"] = wasmExports["Fc"];
  _addBoolVectorToInputSidePacket = Module["_addBoolVectorToInputSidePacket"] = wasmExports["Gc"];
  _addDoubleVectorToInputSidePacket = Module["_addDoubleVectorToInputSidePacket"] = wasmExports["Hc"];
  _addFloatVectorToInputSidePacket = Module["_addFloatVectorToInputSidePacket"] = wasmExports["Ic"];
  _addIntVectorToInputSidePacket = Module["_addIntVectorToInputSidePacket"] = wasmExports["Jc"];
  _addUintVectorToInputSidePacket = Module["_addUintVectorToInputSidePacket"] = wasmExports["Kc"];
  _addStringVectorToInputSidePacket = Module["_addStringVectorToInputSidePacket"] = wasmExports["Lc"];
  _attachBoolListener = Module["_attachBoolListener"] = wasmExports["Mc"];
  _attachBoolVectorListener = Module["_attachBoolVectorListener"] = wasmExports["Nc"];
  _attachDoubleListener = Module["_attachDoubleListener"] = wasmExports["Oc"];
  _attachDoubleVectorListener = Module["_attachDoubleVectorListener"] = wasmExports["Pc"];
  _attachFloatListener = Module["_attachFloatListener"] = wasmExports["Qc"];
  _attachFloatVectorListener = Module["_attachFloatVectorListener"] = wasmExports["Rc"];
  _attachIntListener = Module["_attachIntListener"] = wasmExports["Sc"];
  _attachIntVectorListener = Module["_attachIntVectorListener"] = wasmExports["Tc"];
  _attachUintListener = Module["_attachUintListener"] = wasmExports["Uc"];
  _attachUintVectorListener = Module["_attachUintVectorListener"] = wasmExports["Vc"];
  _attachStringListener = Module["_attachStringListener"] = wasmExports["Wc"];
  _attachStringVectorListener = Module["_attachStringVectorListener"] = wasmExports["Xc"];
  _attachProtoListener = Module["_attachProtoListener"] = wasmExports["Yc"];
  _attachProtoVectorListener = Module["_attachProtoVectorListener"] = wasmExports["Zc"];
  _getGraphConfig = Module["_getGraphConfig"] = wasmExports["_c"];
  _emwgpuCreateBindGroup = wasmExports["$c"];
  _emwgpuCreateBindGroupLayout = wasmExports["ad"];
  _emwgpuCreateCommandBuffer = wasmExports["bd"];
  _emwgpuCreateCommandEncoder = wasmExports["cd"];
  _emwgpuCreateComputePassEncoder = wasmExports["dd"];
  _emwgpuCreateComputePipeline = wasmExports["ed"];
  _emwgpuCreateExternalTexture = wasmExports["fd"];
  _emwgpuCreatePipelineLayout = wasmExports["gd"];
  _emwgpuCreateQuerySet = wasmExports["hd"];
  _emwgpuCreateRenderBundle = wasmExports["id"];
  _emwgpuCreateRenderBundleEncoder = wasmExports["jd"];
  _emwgpuCreateRenderPassEncoder = wasmExports["kd"];
  _emwgpuCreateRenderPipeline = wasmExports["ld"];
  _emwgpuCreateSampler = wasmExports["md"];
  _emwgpuCreateSurface = wasmExports["nd"];
  _emwgpuCreateTexture = wasmExports["od"];
  _emwgpuCreateTextureView = wasmExports["pd"];
  _emwgpuCreateAdapter = wasmExports["qd"];
  _emwgpuImportBuffer = wasmExports["rd"];
  _emwgpuCreateDevice = wasmExports["sd"];
  _emwgpuCreateQueue = wasmExports["td"];
  _emwgpuCreateShaderModule = wasmExports["ud"];
  _clearSubgraphs = Module["_clearSubgraphs"] = wasmExports["vd"];
  _pushBinarySubgraph = Module["_pushBinarySubgraph"] = wasmExports["wd"];
  _pushTextSubgraph = Module["_pushTextSubgraph"] = wasmExports["xd"];
  _changeBinaryGraph = Module["_changeBinaryGraph"] = wasmExports["yd"];
  _changeTextGraph = Module["_changeTextGraph"] = wasmExports["zd"];
  _processGl = Module["_processGl"] = wasmExports["Ad"];
  _process = Module["_process"] = wasmExports["Bd"];
  _bindTextureToCanvas = Module["_bindTextureToCanvas"] = wasmExports["Cd"];
  _requestShaderRefreshOnGraphChange = Module["_requestShaderRefreshOnGraphChange"] = wasmExports["Dd"];
  _waitUntilIdle = Module["_waitUntilIdle"] = wasmExports["Ed"];
  _closeGraph = Module["_closeGraph"] = wasmExports["Fd"];
  _setAutoRenderToScreen = Module["_setAutoRenderToScreen"] = wasmExports["Gd"];
